...
class QAlexNet_MNIST_FP(pl.LightningModule):
    def __init__(self, data_dir='./data', num_classes=10, patience=5, threshold=1.e-4, accumulation_steps=1,
        ...
        super(QAlexNet_MNIST_FP, self).__init__()
        ...
        self.layers = nn.Sequential(
            # Extractor
            QConv2d_FP(in_channels=1, out_channels=64, kernel_size=11, stride=4, padding=5, **self.qargs),
            nn.ReLU(),
            ...
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=2, stride=2),
            QLinear_FP(256, num_classes, **self.qargs)
        )
