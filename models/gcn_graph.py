...
class GCN(torch.nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, output_dim, num_layers,
        ...
        self.convs.extend([GCNConv(hidden_dim, hidden_dim, bias=False, improved=True) for i in range(num_layers - 2)])
        self.convs.extend([GCNConv(hidden_dim, output_dim, bias=True, improved=True)])
...
class GCN_Graph(pl.LightningModule):
    # Source https://zhuanlan.zhihu.com/p/395507027
    def __init__(self, evaluator_name, data_dir='./data', num_classes=10, initializer=None, patience=5, threshold=1.e-4, accumulation_steps=1,
        ...
        self.gnn_node = GCN(self.hidden_dim, self.hidden_dim,
                            self.hidden_dim, self.num_layers, self.dropout, return_embeds=True)
