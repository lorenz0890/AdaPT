...
class ResNet_MNIST(pl.LightningModule):

    def __init__(self, data_dir='./data', depth=20, num_classes=1000, patience=5, threshold=1.e-4,
                 accumulation_steps=1, l1_decay=1e-4, initializer=None, initializer_arg=0.5,
